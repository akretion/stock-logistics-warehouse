...
class TestBatchPicking(TransactionCase):
    ...
    def setUp(self):
        """ Create a picking wave with two pickings from stock to customer """
        ...
        self.wave = self.env['stock.picking.wave'].create({
            'name': 'Batch 1',
    ...
    def test_simple_wave_with_manual_qty_done(self):
        ...
        # confirm wave, picking should be assigned
        self.wave.confirm_picking()
    ...
    def test_simple_wave_with_wizard(self):
        ...
        immediate_transfer_wizard_dict = self.wave.done()
    ...
    def test_wave_with_backorder_wizard(self):
        """ Test a simple wave picking with only one quantity fully available.
        The user will set by himself the quantity reserved for each picking and
        run the picking wave. There should be a wizard asking for a backorder.
        """
        ...
        # There should be a wizard asking to process picking without quantity done
        back_order_wizard_dict = self.wave.done()
    ...
    def test_wave_with_immediate_transfer_and_backorder_wizard(self):
        """ Test a simple wave picking with only one product fully available.
    ...
    def test_wave_with_immediate_transfer_and_backorder_wizard_with_manual_operations(self):
        """ Test a simple wave picking with only one quantity fully available.
